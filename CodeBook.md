...
The data in provided are the result of culling and aggregation from "Human Activity Recognition Using Smartphones Datasets" (HAR) as provided by Snartlab from Università degli Studi di Genova. (see ReadMe.md and ReadMe_HAR.txt [or Appendix A of this document] for more information.)
...
### Appendix A
#### Original HAR ReadMe with descriptions of data and variables
==================================================================
